...
const Body = () => {
    ...
    return (
        <div className="w-full h-[100px] sm:h-[90px] absolute top-0 right-0 bg-[rgba(0,0,0,0)] backdrop-blur-md z-30 px-3 flex justify-start items-center ">
            <div className="w-full h-full z-40 relative flex items-start justify-center lg:justify-between " >
                ...
                <p className="text-gray-400 text-[6pt] max-w-2xl px-5 text-center ">Create a link for your chatroom. Join chatrooms using the join now button</p>
                </div>
